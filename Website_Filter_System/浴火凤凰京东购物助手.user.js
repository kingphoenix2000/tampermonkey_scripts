...
// @description:en        在京东商城的商品搜索结果页面顶部生成一个筛选按钮，点击按钮会生成一些筛选条件，可以按照商品店铺、商品包含的内容关键字、商品评价数、商品的标签等等类别进行筛选。作者：浴火凤凰(QQ:307053741,油猴脚本讨论QQ群:194885662)
// @description:zh-CN     在京东商城的商品搜索结果页面顶部生成一个筛选按钮，点击按钮会生成一些筛选条件，可以按照商品店铺、商品包含的内容关键字、商品评价数、商品的标签等等类别进行筛选。作者：浴火凤凰(QQ:307053741,油猴脚本讨论QQ群:194885662)
...
(function () {
    ...
    function setJDHelper() {
        ...
        function setTypeSelection(object) {
            ...
            select.innerHTML = '';
            select.style.cssText = "width: 180px;height: 23px;";
